...
(function (global) {
  ...
  var DICT = {
    en: {
      ...
      howItem: 'Items: P power up · S spread · L laser · M homing missiles · + heal · E energy · G shield.',
      howAim: 'Aim tracer: a faint dashed line previews where your shots land (toggle: L or settings) — line up before you spend ammo.',
      ...
      aimLineLabel: 'Aim line (dashed tracer)',
    ...
    zh: {
      ...
      howItem: '道具：P 火力 · S 散弹 · L 激光 · M 追踪导弹 · + 回血 · E 能量 · G 护盾。',
      howAim: '瞄准虚线：淡淡的虚线预示弹道落点（按 L 或在设置中开关），对准再开火，省子弹。',
